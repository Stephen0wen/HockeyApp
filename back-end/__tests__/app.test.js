  ...
  test("PATCH 200: Should update a fixture object and return it", () => {
    return request(app)
      ...
      .then(({ body }) => {
        ...
        expect(fixture.match_status).toBe("upcoming");
        expect(fixture.team1_id).toBe(5);
        expect(fixture.team2_id).toBe(4);
        expect(fixture.team1_score).toBe(0);
        expect(fixture.team2_score).toBe(0);
